...
const CreatePoint = () => {
    //array ou objeto: manulmente informar o tipo da variavel
    ...
    function hanleSelectUf(event:ChangeEvent<HTMLSelectElement>){
            const uf = event.target.value
            setSelectUf(uf)
    }

    function hanleSelectCity(event:ChangeEvent<HTMLSelectElement>){
...
//criar a tela de notificação depois
history.push('/')
}
                ...
                <fieldset>
                    ...
                    <div className="field-group">
                        ...
                        <div className="field">
                            ...
                            <select name="uf" id="uf" onChange={hanleSelectUf} value={selectUf}>
                        ...
                        <div className="field">
                            ...
                            <select name="city" id="city" onChange={hanleSelectCity} value={selectCity}>
